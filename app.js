...
const EXAM_SEARCH_URL = `https://sheets.googleapis.com/v4/spreadsheets/${SPREADSHEET_ID}/values/Exam%20Search/?key=${API_KEY}`
...
function createAllocationElement(id, allocation) {
  ...
  allocationElement.className = "allocation"
